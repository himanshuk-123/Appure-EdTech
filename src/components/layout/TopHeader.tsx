  ...
  if (isHomeScreen) {
    return (
      <header className="sticky top-0 z-40 bg-[#f8f9ff]/95 dark:bg-[#0b1c30]/95 backdrop-blur-md border-b border-[#c3c6d7]/30 dark:border-slate-800 transition-colors">
        <div className="flex items-center justify-between px-4 py-3 max-w-md md:max-w-2xl mx-auto w-full">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-white dark:border-slate-700 shadow-sm shrink-0 relative">
              <img
            ...
            <div>
              <h1 className="text-[19px] font-bold text-[#0b1c30] dark:text-white leading-tight flex items-center gap-1.5">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 border border-slate-200 dark:border-slate-700 hover:bg-blue-50 transition-colors shadow-sm"
            >
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-full bg-white dark:bg-slate-800 text-[#434655] dark:text-slate-300 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 transition-colors relative shadow-sm"
            >
